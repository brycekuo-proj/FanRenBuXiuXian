...
第三章《修仙界想吃我／坊市沒有好人》正文第一版已完成並落檔：`data/content/chapter3_full_text.md`。目前為 54,006 個 Unicode 字元、209 個 `ch3.*` 正文區段、74 個主段落；內容不是骨架，直接承接第二章青石坊市伏筆，已完成入市費、抄書與真假功法、丹藥與試藥、酒樓情報、採藥與商隊、黑市、封街與瘟病、王家名冊、青禾會、向下分配風險、小順線、死亡／墓誌銘／死後情報與多種存活收束。第三章核心完成「自己死 → 看別人死」的轉折，同一表面事件保留不同真相，保守選項有明確金錢／機會成本，章末正式接到第四章「打了小的，來了老的；但今天的小的是我」。
